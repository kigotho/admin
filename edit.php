...
<body>
	...
	<form name="form1" method="post" action="edit.php">
		<table border="0">
            ...
            <tr> 
                <td>PDF</td>
                <td><input type="text" name="email" value=<?php echo $pdf;?>></td>
            </tr>
            <tr> 
                <td>Categories</td>
                <td><input type="text" name="email" value=<?php echo $categories;?>></td>
            </tr>
            <tr> 
                <td>Product Image</td>
                <td><input type="text" name="email" value=<?php echo $image;?>></td>
            </tr>
			<tr>
